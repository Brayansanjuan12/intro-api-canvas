...
const canvasNube = document.getElementById("canvasNubes");
const canvasCora = document.getElementById("canvasCora");
const canvasReci = document.getElementById("canvasReci");
